...
export function Badge({ children, tone = "neutral", variant = "soft", style = {}, ...rest }: BadgeProps) {
  const palette = {
  ...
  const soft  = { background: palette.bg,    color: palette.fg,                                           border: "1px solid transparent" };
  const solid = { background: palette.solid, color: tone === "neutral" ? "var(--paper)" : "#fff",         border: "1px solid transparent" };
